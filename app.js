...
function getElements() {
  return {
    ...
    travelGuideBudgetMin: document.getElementById("travelGuideBudgetMin"),
    travelGuideBudgetMax: document.getElementById("travelGuideBudgetMax"),
    travelGuideStayType: document.getElementById("travelGuideStayType"),
